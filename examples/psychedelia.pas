(* psychedelia.pas  -*- Object Pascal -*-
 *
 * To build from command line:
 * FPC: fpc -B -Fu.. psychedelia.pas
 * Delphi: dcc64 -B -U.. -NSSystem psychedelia.pas
 *
 * Variation on 'plasma.c', as described here:
 * https://lodev.org/cgtutor/plasma.html
 * psychedelia.c written by Guido Gonzato, 2018 - 2019.
 * psychedelia.pas written by Ioulianos Kakoulidis, December 2020.
 *
...
begin
  ...
  showinfobox ('Left click to switch between putbuffer() and putpixel()');
